...
import com.shreya.repository.PasswordResetTokenRepository;
...
public class UserServiceImplementation implements UserService {
	...
	public User findUserProfileByJwt(String jwt) throws UserException, ProjectException {
		// JwtService.getEmailFromToken will accept either a "Bearer ..." header or a raw token.
		...
		// Only save if you changed something on user. Removing automatic save to avoid accidental writes.
		return user;
	}
