...
// <-- new import: use the shared tags list
                  ...
                  <FormField
                      ...
                      render={({ field }) => (
                          <FormItem>
                            <FormControl>
                              <Select
                                  // bind the RHF value -> makes the Select reflect form.reset(...)
                                  value={field.value ?? project.projectDetails?.category ?? ""}
                          ...
                          <FormItem>
                            <FormControl>
                              ...
                              >
                                ...
                                <SelectContent>
                                  {/* <- replaced static list with mapped shared tags */}
                                  {tags.map((tag) => (
